 ...
 * @method ?string getAnalysisText()
 * @method void setAnalysisText(?string $analysisText)
 ...
 */
class RoomImageSource extends Entity implements JsonSerializable {
	...
	protected ?string $analysisText = null;
